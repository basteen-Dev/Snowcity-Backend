...
async function testComboSlotsAPI() {
  ...
  try {
    ...
    const response = await axios.get(`https://snowcity-backend-zjlj.onrender.com0/api/combos/1/slots?date=2025-11-29`);
...
async function testAttractionSlotsAPI() {
  ...
  try {
    const axios = require('axios');
    const response = await axios.get(`https://snowcity-backend-zjlj.onrender.com0/api/attractions/1/slots?date=2025-11-29`);
...
async function testDirectSlotsAPI() {
  ...
  try {
    const axios = require('axios');
    const response = await axios.get(`https://snowcity-backend-zjlj.onrender.com0/api/slots?attraction_id=1&date=2025-11-29`);
