...
async function testDatabaseConnection() {
  ...
  try {
    ...
    const response = await axios.get('https://snowcity-backend-zjlj.onrender.com0/api/combos');
    ...
    if (response.data?.data?.length > 0) {
      ...
      const slotsResponse = await axios.get(`https://snowcity-backend-zjlj.onrender.com0/api/combos/${comboId}/slots?date=2025-11-29`);
