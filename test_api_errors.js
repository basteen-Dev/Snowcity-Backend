...
console.log('   Navigate to: https://snowcity-backend-zjlj.onrender.com0/admin/catalog/attraction-slots');
...
console.log('   Navigate to: https://snowcity-backend-zjlj.onrender.com0/admin/catalog/combo-slots');
