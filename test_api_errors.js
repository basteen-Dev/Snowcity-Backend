...
console.log('   Navigate to: https://snowcity-backend-zjlj.onrender.com/admin/catalog/attraction-slots');
...
console.log('   Navigate to: https://snowcity-backend-zjlj.onrender.com/admin/catalog/combo-slots');
